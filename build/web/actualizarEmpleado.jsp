<%-- 
    ...
    Created on : 24/08/2020, 12:48:26 AM
    Author     : 57350
--%>
    ...
    <body class="header-fixed sidebar-fixed sidebar-dark header-light" id="body">
        <script>
            ...
            <div class="row">
                ...
                <% EmpleadoVO EmpVO = (EmpleadoVO) request.getAttribute("empleado");
            if (EmpVO != null) {%>
                <form action="Empleado" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="inputplaca">Usuario</label>
                            <input type="number" name="textUsuario" class="form-control" id="inputplaca" value="<%=EmpVO.getusuId()%>">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputDatos">Tipo identificación</label>
                            <input type="text" name="textTipoIdentificacion" class="form-control" id="inputDatos" value="<%=EmpVO.getTipo_identificacion()%>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="inputCategor">Número identificación</label>
                            <input type="number" name="textNumeroIdentificacion" class="form-control" id="inputCategor" value="<%=EmpVO.getN_identificacion()%>">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputModelo">Nombres</label>
                            <input type="text" name="textNombreEmpleado" class="form-control" id="inputModelo" value="<%=EmpVO.getNombre_emp()%>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="textApellidoEmpleado" class="form-control" id="inputMarca" value="<%=EmpVO.getApellido_emp()%>">
                        </div>
                    </div> 
                    ...
                    <%} %>
                    <br>
                    <a href="consultarEmpleado.jsp" style="color: #fed181">Volver</a><br>
                    <div style="color: red">
