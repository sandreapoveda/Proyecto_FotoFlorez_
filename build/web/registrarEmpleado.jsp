                                ...
                                <ol class="breadcrumb p-0">
                                    <li class="breadcrumb-item">
                                        <a href="index.html">
                                            ...
                                            <div class="card-body">
                                                <form class="form-pill" method="post" action="Empleado" >
                                                    <div class="form-group">
                                                        <label for="exampleFormControlInput3">Usuario</label>
                                                        <input type="number" name="textUsuario" class="form-control" id="exampleFormControlInput3" placeholder="Introduzca su usuario" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlInput3">Tipo identificación</label>
                                                        <input type="text" name="textTipoIdentificacion" class="form-control" id="exampleFormControlInput3" placeholder="Introduzca su tipo de identificación" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlPassword3">Número identificación</label>
                                                        <input type="number" name="textNumeroIdentificacion" class="form-control" id="exampleFormControlPassword3" placeholder="Introduzca su número de identificación" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlInput3">Nombres</label>
                                                        <input type="text" name="textNombreEmpleado" class="form-control" id="exampleFormControlInput3" placeholder="Introduzca sus nombres" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlInput3">Apellidos</label>
                                                        <input type="text" name="textApellidoEmpleado" class="form-control" id="exampleFormControlInput3" placeholder="Introduzca sus apellidos" required >
                                                    </div>
                                                    <div class="modal-footer px-4">
                                                        <button type="hidden" value="1" name="opcion"  class="mb-1 btn btn-sm btn-outline" style="background-color: #fed181; color: #000;">Agregar usuario</button>
                                                    </div>
