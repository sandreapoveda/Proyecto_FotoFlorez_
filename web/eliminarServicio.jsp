<%-- 
    ...
    Created on : 17/09/2020, 09:18:05 PM
    Author     : sharo
--%>
                            ...
                            <li  class="has-sub active expand" >
                                <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#app"
                                   aria-expanded="false" aria-controls="app">
                                    ...
                                    <span class="nav-text">Aplicaciones</span> <b class="caret"></b>
                                </a>
                                <ul  class="collapse show"  id="app"
                                    ...
                                    <div class="sub-menu">
                                        ...
                                        <li >
                                            <a class="sidenav-item-link" href="calendario/examples/example00-basic.html">
                            ...
                            <li  class="has-sub" >
                                ...
                                <ul  class="collapse"  id="tables"
                                    ...
                                    <div class="sub-menu">
                                        ...
                                        <li >
                                            <a class="sidenav-item-link" href="eliminarServicio.jsp">
                            ...
                            <div class="col-12">
                                ...
                                <div class="card card-table-border-none" id="recent-orders">
                                    <div class="card-header justify-content-between">
                                        ...
                                        </div><form method="post" action="Servicio">
                                <table>
                                    <tr>
                                        <th>
                                            <p><input type="text" name="textId" 
                                                      placeholder="Ingrese id servicio"><br></p>
                                        </th>    
                                    </tr>
                                </table>                            
                                <button type="submit" style="background: #fed181;">Eliminar</button>
