                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb p-0"> 
                                            <li class="breadcrumb-item">
                                                <a href="consultarServicio.jsp">
                                                    <span class="mdi mdi-home">Atrás</span>                
                                                </a>
                                            </li>
                                            <li class="breadcrumb-item" aria-current="page">Registrar servicio</li>
                                        </ol>
                                    </nav>  
                                </div>
                            </div>
                            <div class="col-10">
        <di                        v class="card card-default">
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="Servicio" >
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label for="exampleFormControlInput1">Tipo catálogo</label>
                                                        <input type="email" name="textTipoCatalogo" class="form-control" id="exampleFormControlInput1" placeholder="Introduzca el tipo de catálogo">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlInput1">Descripción servicio</label>
                                                        <input type="text" name="textDescripcionServicio" class="form-control" id="exampleFormControlInput1" placeholder="Introduzca la descripción del servicio" required>
                                                    </div>
                                                    <div class="modal-footer px-4">
                                                        <button type="hidden" value="1" name="opcion"  class="mb-1 btn btn-sm btn-outline" style="background-color: #fed181; color: #000;">Agregar servicio</button>
                                                    </div>
